    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              <div className="text-4xl font-bold text-foreground">{todayOrders.length}</div>
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              <div className="text-4xl font-bold text-destructive">{errorOrders.length}</div>
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              <div className="text-4xl font-bold text-foreground">
                {purchaseOrders.length > 0 ? formatTime(purchaseOrders[0].created_at) : "--:--:--"}
              </div>
              ...
              {[...purchaseOrders]
                ...
                .map((po) => (
                  <Card key={po.pdfName} className="bg-card border-border">
                    <Collapsible>
                      <CollapsibleTrigger className="w-full" onClick={() => toggleCard(po.pdfName)}>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="text-left">
                                <CardTitle className="text-base font-medium text-foreground">{po.pdfName}</CardTitle>
                                <p className="text-sm text-muted-foreground mt-1">PO: {po.poNumber}</p>
                              </div>
                            </div>
                      ...
                      <CollapsibleContent>
                        <CardContent className="pt-0">
                          <div className="space-y-4 pl-7">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                      <div className="bg-background rounded-md p-3 border border-border">
                                        ...
                                        <div className="text-sm font-medium text-foreground">
                                          {po.finalSOHeaderOutput.customerName || "N/A"}
                                        </div>
                                      </div>
                                      <div className="bg-background rounded-md p-3 border border-border">
                                        <div className="text-xs text-muted-foreground mb-1">Customer Number</div>
                                        <div className="text-sm font-medium text-foreground">
                                          {po.finalSOHeaderOutput.customerNumber || "N/A"}
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                      <div className="bg-background rounded-md p-3 border border-border">
                                        ...
                                        <div className="text-sm font-medium text-foreground">
                                          {po.finalSOHeaderOutput.billToAddressLine1 ||
                                            po.finalSOHeaderOutput.shipToAddressLine1 ||
                                            "N/A"}
                                        </div>
                                      </div>
                                      <div className="bg-background rounded-md p-3 border border-border">
                                        ...
                                        <div className="text-sm font-medium text-foreground">
                                          {po.finalSOHeaderOutput.sellToAddressLine1?.split(",").pop()?.trim() || "N/A"}
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                      <div className="bg-background rounded-md p-3 border border-border">
                                        ...
                                        <div className="text-sm font-medium text-foreground">
                                          {po.finalSOHeaderOutput.orderDate || "N/A"}
                                        </div>
                                      </div>
                                      <div className="bg-background rounded-md p-3 border border-border">
                                        <div className="text-xs text-muted-foreground mb-1">Amount (Ex Tax)</div>
                                        <div className="text-sm font-bold text-foreground">
                                          {po.finalSOHeaderOutput.currencyCode || ""}{" "}
                                          {po.finalSOHeaderOutput.totalAmountExcludingTax || "N/A"}
                                        </div>
                                      </div>
                                      <div className="bg-background rounded-md p-3 border border-border">
                                        ...
                                        <div className="text-sm font-medium text-foreground">
                                          {po.finalSOHeaderOutput.currencyCode || ""}{" "}
                                          {po.finalSOHeaderOutput.totalTaxAmount || "0"}
                                        </div>
                                      </div>
                                      {po.finalSOHeaderOutput.totalTaxAmount &&
                                        ...
                                        po.finalSOHeaderOutput.totalAmountIncludingTax && (
                                          <div className="bg-background rounded-md p-3 border border-border">
                                            <div className="text-xs text-muted-foreground mb-1">Total (Inc Tax)</div>
                            ...
                            {po.finalLinesOutput && po.finalLinesOutput.length > 0 && (
                              <div className="space-y-2">
                                ...
                                <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 border-2 border-blue-200 dark:border-blue-800">
                                  <div className="space-y-2">
                                    {po.finalLinesOutput.map((line, index) => (
                                      <div
                                        key={index}
                                      ...
                                      >
                                        ...
                                        <div className="flex items-center gap-2 min-w-0 flex-1">
                                          ...
                                          <span
                                            ...
                                            title={line.json.itemDescription}
                                          >
                                        ...
                                        <div className="flex items-center gap-2 min-w-0">
                                          ...
                                          <span className="text-sm text-foreground">
                                            {line.json.unitOfMeasureCode || "N/A"}
                                          </span>
                                        </div>
                                ...
                                <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-3">
                                  <div className="space-y-3">
                                    <ul className="text-sm text-destructive space-y-1">
                                      {getErrorDetails(po).map((error, index) => (
