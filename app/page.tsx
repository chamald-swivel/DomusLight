                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div className="flex justify-between">
                                      ...
                                      <span className="text-foreground">
                                        {po.finalSOHeaderOutput.sellToCity
                                          ?.split(",")
                                          .pop()
                                          ?.trim() || "N/A"}
                                      </span>
                                          ...
                                          <div className="mt-3 space-y-2">
                                            ...
                                            {errorLines.map(
                                              (errorLine, index) => (
                                                <div
                                                  key={index}
                                                  className="bg-destructive/5 border border-destructive/10 rounded p-2"
                                                >
                                                  <pre className="text-xs text-destructive font-mono whitespace-pre-wrap overflow-x-auto">
                                                    {JSON.stringify(
                                                      errorLine.json,
                                                      null,
                                                      2
